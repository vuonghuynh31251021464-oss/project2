...
st.set_page_config(page_title="Perceptron + Fuzzy Prediction Suite", layout="wide")
...
st.title("🌐 Prediction System: Perceptron + Fuzzy Logic")
st.markdown("### 🧩 Multi-domain intelligent classification models")
...
# ========================
    ...
    # Simple Perceptron Demo Dataset
    X = np.array([
        [5.5, 0.2, 60],
        [6.5, 0.5, 50],
        [7.5, 0.3, 40],
    ...
    y = np.array([0, 2, 1, 0, 2])  # 0=Rice, 1=Corn, 2=Vegetables
...
st.caption("Developed with ❤️ using Streamlit, Scikit-learn, and Fuzzy Logic Control.")
